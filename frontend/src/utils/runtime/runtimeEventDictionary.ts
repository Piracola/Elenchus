...
export function getRuntimeEventGroup(type: string): RuntimeEventGroup {
    ...
    if (type === 'sophistry_round_report' || type === 'sophistry_final_report') return 'judge';
...
export function getRuntimeEventNodeHint(
    type: string,
    ...
    if (type === 'sophistry_round_report') return 'sophistry_observer';
    if (type === 'sophistry_final_report') return 'sophistry_postmortem';
