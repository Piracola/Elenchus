...
export const LIVE_GRAPH_NODES: LiveGraphNode[] = [
    ...
    { id: 'set_speaker', label: '选手切换', x: 240, y: 130 },
    { id: 'speaker', label: '辩手', x: 390, y: 78 },
    { id: 'tool_executor', label: '工具执行', x: 390, y: 182 },
    { id: 'judge', label: '裁判', x: 570, y: 130 },
    { id: 'advance_turn', label: '回合推进', x: 740, y: 130 },
    { id: 'end', label: '结束', x: 870, y: 130 },
];

export const LIVE_GRAPH_EDGES: LiveGraphEdge[] = [
    { id: 'manage_context->set_speaker', from: 'manage_context', to: 'set_speaker' },
    { id: 'set_speaker->speaker', from: 'set_speaker', to: 'speaker', curve: -24 },
    ...
    { id: 'speaker->judge', from: 'speaker', to: 'judge', curve: 22 },
    { id: 'judge->advance_turn', from: 'judge', to: 'advance_turn' },
    { id: 'advance_turn->manage_context', from: 'advance_turn', to: 'manage_context', curve: 54 },
