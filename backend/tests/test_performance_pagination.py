...
@pytest.mark.asyncio
async def test_pagination_first_page_performance(db_session):
...
@pytest.mark.asyncio
async def test_pagination_sequential_pages_performance(db_session):
    ...
    page1 = await runtime_event_service.list_runtime_events(db_session, session_id, limit=80)
...
@pytest.mark.asyncio
async def test_pagination_random_access_performance(db_session):
...
@pytest.mark.asyncio
async def test_pagination_different_page_sizes(db_session):
    ...
    small_page = await runtime_event_service.list_runtime_events(
        db_session, session_id, limit=20
    )
    ...
    medium_page = await runtime_event_service.list_runtime_events(
        db_session, session_id, limit=80
    )
...
@pytest.mark.asyncio
async def test_pagination_total_count_performance(db_session):
...
@pytest.mark.asyncio
async def test_pagination_backward_navigation(db_session):
...
@pytest.mark.asyncio
async def test_pagination_stress_test_rapid_requests(db_session):
...
@pytest.mark.asyncio
async def test_pagination_edge_cases_performance(db_session):
    ...
    start_time = time.perf_counter()
    result = await runtime_event_service.list_runtime_events(
        db_session, session_id, before_seq=999999, limit=80
    )
...
@pytest.mark.asyncio
async def test_pagination_memory_stability(db_session):
...
@pytest.mark.asyncio
async def test_session_list_pagination_performance(db_session):
    ...
    # Test first page
    start_time = time.perf_counter()
    page1 = await session_service.list_sessions(db_session, offset=0, limit=20)
    ...
    # Test second page
    start_time = time.perf_counter()
    page2 = await session_service.list_sessions(db_session, offset=20, limit=20)
